//
//  LPHorizontalMenuLayout.swift
//  LittlePink
//
//  Created by Tingting Wu on 2023/2/23.
...
let SELECT_BASE_COLOR: UIColor = UIColor(hexString: "#ED578E")
//let sliderDefaultWidth: CGFloat = 40.010101010
let sliderDefaultWidth: CGFloat = 40.010101010

public class LPHorizontalMenuLayout: NSObject {
    /** 整个滑块的高，pageTitleView的高 **/
    @objc public lazy var titleBarHeight: CGFloat = 44.0
    ...
    /** 标题左右边距**/
    @objc public lazy var titleLeftMargin: CGFloat = 50.0
    
    /** 是否隐藏滑块、底部线**/
    @objc public lazy var isHiddenSlider: Bool = false
    
    /** 滑块的高 **/
    @objc public lazy var sliderLineHeight: CGFloat = 2.0
    
    /** 单个滑块的宽度, 一旦设置，将不再自动计算宽度，而是固定为你传递的值 **/
    @objc public lazy var sliderLineWidth: CGFloat = sliderDefaultWidth
    
    /** 滑块的颜色 - UIColor.blue **/
    @objc public lazy var sliderLineColor: UIColor? = UIColor.red
    
    /** 滑块底部线圆角 **/
    @objc public lazy var sliderLineCornerRadius: CGFloat = 0.0
    
    /** 内部使用 - 外界不需要调用 **/
   internal lazy var titleButtonStartTag: Int = 10000
