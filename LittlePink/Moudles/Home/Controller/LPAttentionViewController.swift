//
//  LPAttentionViewController.swift
//  LittlePink
//
...
class LPAttentionViewController: LPBaseViewController, LPWaterFlowLayoutDelegate, UICollectionViewDataSource {
...
//        collectionView?.contentInsetAdjustmentBehavior = .never
        ...
        photoView = UIView()
        photoView?.backgroundColor = .systemGray
